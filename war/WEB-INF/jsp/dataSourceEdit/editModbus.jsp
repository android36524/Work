...
<%@ include file="/WEB-INF/jsp/dataSourceEdit/dsHead.jspf" %>
  ...
  <td valign="top">
    <div class="borderDiv marB marR" style="float:left;display: none">
      <table>
    ...
    <div class="borderDiv marB" id="locatorTestDiv" style="clear:both;display: none">
      <table>
...
<tag:acpList  pointHelpId="virtualPP">
</tag:acpList>
<tag:systemPointsList  pointHelpId="virtualPP">
</tag:systemPointsList>