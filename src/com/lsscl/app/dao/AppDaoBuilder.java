...
import com.lsscl.app.dao.impl3.AcpStatisticsDao;
import com.lsscl.app.dao.impl3.AlarmAcpPointsDao;
import com.lsscl.app.dao.impl3.ScopeBasePointStatisticsDao;
import com.lsscl.app.dao.impl3.ScopePowerStatisticsDao;
...
public class AppDaoBuilder {
	...
	public static AppDao create(String msgId){
		...
		if("AcpStatistics".equals(msgId))return new AcpStatisticsDao();
		if("AcpPowerStatistics".equals(msgId))return new AcpPowerStatisticsDao();
		if("AcpSearch".equals(msgId))return new AcpSearchDao();
		if("AlarmAcpPoints".equals(msgId))return new AlarmAcpPointsDao();
		if("ScopePowerStatistics".equals(msgId))return new ScopePowerStatisticsDao();
		if("ScopeBasePointStatistics".equals(msgId))return new ScopeBasePointStatisticsDao();
