    ...
    <td valign="top">
      <div id="pointDetails" class="borderDiv marR marB" style="display: none;">
        ...
        <table>
          ...
          <tr>
            <td class="formLabelRequired"><fmt:message key="app.point.baseType"/></td>
            <td class="formField">
	            <select id="pointTypeId">
	                <option value="0"></option>
	                <option value="1"><fmt:message key="app.basePoint1"/></option>
	                <option value="2"><fmt:message key="app.basePoint2"/></option>
	                <option value="3"><fmt:message key="app.basePoint3"/></option>
	                <option value="4"><fmt:message key="app.basePoint4"/></option>
	            </select>
            </td>
          </tr>
          <tr>
            <td class="formLabelRequired"><fmt:message key="dsEdit.points.sortid"/></td>
            <td class="formField"><input type="number" id="sortid"/></td>
          </tr>
        </table>
      </div>
    </td>
